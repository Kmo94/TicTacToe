...
namespace TicTacToeServer
{
    ...
    public partial class Play : Form
    {
        ...
        private void Play_Load(object sender, EventArgs e)
        {
            ...
            {
                listener = new TcpListener(Form1.ptNum);
                listener.Start();
        ...
        private void btnPosTwo_Click(object sender, EventArgs e)
        {
        ...
        private void Play_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
